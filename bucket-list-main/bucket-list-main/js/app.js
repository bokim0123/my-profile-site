...
class BucketListApp {
    ...
    createBucketItemHTML(item) {
        ...
        const completedItemClass = item.completed ? 'completed' : '';

        return `
            <div class="bucket-item ${completedItemClass}">
                <!-- 체크박스 -->
                <button
                    class="flex-shrink-0 w-7 h-7 rounded-lg border-2 flex items-center justify-center font-bold ${checkboxClass} transition-all"
                ...
                <div class="flex gap-2 flex-shrink-0">
                    <button
                        class="action-btn px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg text-sm font-semibold hover:shadow-md transition-all"
                    ...
                    <button
                        class="action-btn px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg text-sm font-semibold hover:shadow-md transition-all"
