...
│  ├─ layout.tsx         # 루트 레이아웃 (Theme, Tooltip, Toaster)
│  ├─ loading.tsx        # 전역 로딩 UI
│  ├─ error.tsx          # 전역 에러 바운더리
│  ├─ not-found.tsx      # 404 페이지
│  ├─ (marketing)/       # Header + Footer: /, /about, /examples/*
│  ├─ (auth)/            # 중앙 카드: /login, /signup
│  └─ (dashboard)/       # Sidebar + Topbar: /dashboard/*
├─ components/
│  ├─ ui/                # L1 shadcn/ui 컴포넌트
│  ├─ common/            # L2 재사용 조합 컴포넌트
│  ├─ layout/            # L3 레이아웃 조각 (Header, Sidebar 등)
│  ├─ sections/          # L4 페이지 블록 (Hero, Features, CTA)
...
const steps = [
  ...
  {
    title: "2. 페이지 추가",
    description: "src/app/(그룹)/{경로}/page.tsx 파일을 만들면 해당 그룹 레이아웃이 적용된 라우트가 생성됩니다.",
  },
  {
    title: "3. 컴포넌트 추가",
